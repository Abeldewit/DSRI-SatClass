...
def one_epoch(
    ...
    # Init metrics
    metric_options = {
        'simple': {'num_classes': 20},
        'weighted': {'num_classes': 20, 'average': 'weighted'},
        'crop_only': {'num_classes': 20, 'ignore_index': [0, 19]},
    }
    simple_accuracy = Accuracy(num_classes=20)
    weighted_accuracy = Accuracy(num_classes=20, average='weighted')
    crop_only_accuracy = Accuracy(num_classes=20, ignore_index=[0, 19])
